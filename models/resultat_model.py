class Resultat:
    def __init__(self, id_resultat: int, buts_equipe1_temps_reglementaire: int, buts_equipe2_temps_reglementaire: int, prolongation: bool = False, tirs_au_but: bool = False, buts_equipe1_apres_prolongation: int = 0, buts_equipe2_apres_prolongation: int = 0, score_equipe1: int | None = None, score_equipe2: int | None = None):
